...
class AutoTrader(BaseAutoTrader):
    ...
    def on_order_book_update_message(self, instrument: int, sequence_number: int, ask_prices: List[int],
        ...
        #kill any orders that have no shot of being filled/they have lasted for more than 10 updates
        removetheseIDs = list()
        for i in self.bids:
            ...
            if(ask_prices[0] - bid_prices[0] > 2*TICK_SIZE_IN_CENTS):
                ...
                if(goingup):
                    ...
                    if(new_bid_price != self.bid_price):
                        ...
                        self.importantorders.pop(self.bid_id, None)
                    ...
                    if(new_ask_price != self.ask_price):
                        ...
                        self.importantorders.pop(self.ask_id, None)
